...
- Property-based classifier invariant tests and endpoint concurrency stress tests.
- Expanded CI lanes for static analysis and extended smoke checks.

### Changed

- Core classifier now uses tally-based priors and updated Bayesian denominator math.
